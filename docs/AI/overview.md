...
- **Self-healing automation**: SmartActions and AiTranslator create tests that automatically adapt when your application changes.
- **Visual testing**: AiTester brings human-like visual inspection capabilities to automated testing.
- **Exploratory testing**: AiRobot enables AI-driven exploratory testing that mimics human interaction.
...
- [AI Dashboard](ai_dashboard.md#ai-dashboard) - Configure AI providers and manage chat sessions
- [AI Panel](ai_dashboard.md#ai-panel) - Work with AI Commands in RVL
- [AI Command](ai_command.md) - Translate manual test steps to automation code

### AI-Powered Testing

- [AiTranslator](aitranslator.md) - Natural language to SmartAction translation
- [AiTester](aitester.md) - AI capabilities during test execution (visual testing, data generation)
- [AiRobot](airobot.md) - Automated exploratory testing with computer use
- [Agentic Chat with MCP](agentic_mcp.md) - Conversational AI with Rapise and Spira tools

### Related Topics

- [SmartActions](../Guide/web_smart_action.md) - Self-healing test automation
- [Self-Healing](../Guide/web_self_healing.md) - Automatic locator repair
