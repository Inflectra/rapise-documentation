...
!!! info "Summary"
    ...
    - [:material-robot-happy-outline: **Inflectra.ai** now enabled during test case playback](../Libraries/AiTester.md#aitester) [IN:12238]
		...
		You can now seamlessly integrate AI into your test execution. Using the [AiTester](/Libraries/AiTester/#aitester) global object, your automated tests can send text-based and image-augmented queries directly to **Inflectra.ai** during playback.
