...
!!! info "Summary"
    - [:material-robot-happy-outline: AI-based self-healing for Web tests](../Guide/web_self_healing.md#self-healing) [IN:12237]

		Rapise 9.0 takes the self-healing capabilities of Web testing to the next level. This version introduces the concept of SmartActions, which includes both the object description and the action intent expressed in human language. Though SmartActions are automatically recorded and translated to a working, cached standard Rapise action, it uses its embedded intelligence to automatically heal the underlying object locator in case of application updates. :rocket:

    - [:material-robot-happy-outline: **Inflectra.ai** now enabled during test case playback](../Libraries/AiTester.md#aitester) [IN:12238]

		You can now seamlessly integrate AI into your test execution. Using the [AiTester](../Libraries/AiTester.md#aitester) global object, your automated tests can send text-based and image-augmented queries directly to **Inflectra.ai** during playback.
...
- [mTLS support for REST endpoints](../Guide/rest_web_service.md#handling-mtls-handshake) [IN:11836]
- [Allow setting custom test run properties via RapiseLauncher](../Libraries/Spira.md#settestruncustomproperty) [IN:11853]
...
- [Spira.SetTestRunCustomProperty](../Libraries/Spira.md#settestruncustomproperty) [IN:12240]
- [AiTester Global Object](../Libraries/AiTester.md#aitester) [IN:12242]
- [Playwright Global Object](../Libraries/Playwright.md#playwright) [IN:12243]

### Improvements

- [Spira Dashboard: Added `Apply Local` button on the Parameters tab to set active configuration for local execution ](../Guide/spira_dashboard_2.md#parameters-view-rapise-80) [IN:11593]
...
- [Spira Dashboard: Added `Check/Uncheck All...` popup menu items to quickly select test cases](../Guide/spira_dashboard_2.md#quick-actions) [IN:11686]
...
- Output view failed to load log file if it was locked by another process [IN:12372]
- geckodriver.exe locked out.log and err.log of the test [IN:12373]
- Firefox preferences were processed incorrectly in Selenium profiles [IN:12374]
- Do not prompt to save Manual Steps if .rmt file does not exist on disk [IN:12378]
- RapiseLauncher did not report that it can not update test set status [IN:12382]
- RapiseLauncherJS made compatible with Spira 9.0 [IN:12430]
