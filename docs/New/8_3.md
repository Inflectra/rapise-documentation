...
!!! info "Summary"
    ...
    - [AI: Add support of AWS Bedrock](../AI/ai_dashboard.md#amazon-bedrock) [IN:10340]
    - [AiTester public module to run AI queries during test execution](../AI/aitester.md) [IN:10421]
    - [AiRobot public module for AI-driven automation](../AI/airobot.md) [IN:10467]
...
- [AI: new AI Command cache format, store commands near RVL files](../AI/ai_dashboard.md#rapise-83-ai-command-cache-changes) [IN:10351]
- [Add Proxy server support in AI](../AI/ai_dashboard.md#proxy) [IN:10400]
