...
**Behavior Pattern: YUICheckButtonBehavior**
...
```javascript
value = SeS('SomeYUICheckButton').GetChecked()
```
...
```javascript
SeS('SomeYUICheckButton').DoSetCheck(bcheck)
```
...
<a name="see.also.yuicheckbutton.dosetcheck"></a>
