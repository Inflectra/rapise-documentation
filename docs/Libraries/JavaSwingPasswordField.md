...
UI element class: javax.swing.JPasswordField
...
```javascript
value = SeS('SomeJavaSwingPasswordField').GetText()
...
```javascript
value = SeS('SomeJavaSwingPasswordField').GetValue()
...
```javascript
SeS('SomeJavaSwingPasswordField').DoSetText(val)
```
