Summary: DevXpress PopupContainerEdit.
...
```javascript
value = SeS('SomeDXPopupContainerEdit').GetText()
...
```javascript
SeS('SomeDXPopupContainerEdit').DoSetText(val)
```
...
<a name="see.also.dxpopupcontaineredit.dosettext"></a>
