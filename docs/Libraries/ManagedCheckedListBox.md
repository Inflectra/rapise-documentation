Summary: Managed Checked ListBox.

# ManagedCheckedListBox

Managed Checked ListBox.
 
UI element class: System.Windows.Forms.CheckedListBox
...
```javascript
value = SeS('SomeManagedCheckedListBox').GetCheckedCount()
```
...
```javascript
value = SeS('SomeManagedCheckedListBox').GetCheckedIndices(asArray, separator)
```
...
```javascript
value = SeS('SomeManagedCheckedListBox').GetCheckedItems(asArray, separator)
```
...
```javascript
value = SeS('SomeManagedCheckedListBox').GetItemCount()
```
...
```javascript
value = SeS('SomeManagedCheckedListBox').GetItemIndexByName(name)
```
...
```javascript
value = SeS('SomeManagedCheckedListBox').GetItemNameByIndex(index)
```
...
```javascript
value = SeS('SomeManagedCheckedListBox').GetSelectedIndex()
...
```javascript
value = SeS('SomeManagedCheckedListBox').GetSelectedIndices(asArray, separator)
```
...
```javascript
value = SeS('SomeManagedCheckedListBox').GetSelectedItems()
```
...
```javascript
value = SeS('SomeManagedCheckedListBox').GetSelectedText()
```
...
```javascript
value = SeS('SomeManagedCheckedListBox').GetSelectionCount()
```
...
```javascript
SeS('SomeManagedCheckedListBox').DoAddSelection(items, separator, itemsType)
```
...
```javascript
SeS('SomeManagedCheckedListBox').DoCheckItem(items, separator, itemsType)
```
...
```javascript
SeS('SomeManagedCheckedListBox').DoClearSelection()
```
...
```javascript
SeS('SomeManagedCheckedListBox').DoRemoveSelection(items, separator, itemsType)
```
...
```javascript
SeS('SomeManagedCheckedListBox').DoSelectItem(items, separator, itemsType)
```
...
```javascript
SeS('SomeManagedCheckedListBox').DoSetCheck(bcheck, items, separator, itemsType)
```
