...
```javascript
value = SeS('SomeDomSalesforceGrid').GetCell(/**number|string*/row, /**string|number*/col)
```
...
```javascript
value = SeS('SomeDomSalesforceGrid').GetColumnCount()
```
...
```javascript
value = SeS('SomeDomSalesforceGrid').GetColumnIndex(/**string*/ columnName)
```
...
```javascript
value = SeS('SomeDomSalesforceGrid').GetColumnName(/**number*/columnIndex)
```
...
```javascript
value = SeS('SomeDomSalesforceGrid').GetRowCount()
```
...
```javascript
SeS('SomeDomSalesforceGrid').DoClickCell(row, col, clickType, xOffset, yOffset)
```
...
```javascript
SeS('SomeDomSalesforceGrid').DoClickText(text, index)
```
