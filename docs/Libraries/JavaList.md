...
**Behavior Pattern: JavaObjectListSelectableBehavior**
...
```javascript
value = SeS('SomeJavaList').GetItemCount()
```
...
```javascript
value = SeS('SomeJavaList').GetItemIndexByName(name)
```
...
```javascript
value = SeS('SomeJavaList').GetItemNameByIndex(index)
```
...
```javascript
value = SeS('SomeJavaList').GetSelectedIndex()
...
```javascript
value = SeS('SomeJavaList').GetSelectedIndices(asArray, separator)
```
...
```javascript
value = SeS('SomeJavaList').GetSelectedItems()
```
...
```javascript
value = SeS('SomeJavaList').GetSelectedText(separator)
```
...
```javascript
value = SeS('SomeJavaList').GetSelectionCount()
```
...
```javascript
SeS('SomeJavaList').DoAddSelection(items, separator, itemsType)
```
...
```javascript
SeS('SomeJavaList').DoClearSelection()
```
...
```javascript
SeS('SomeJavaList').DoRemoveSelection(items, separator, itemsType)
```
...
```javascript
SeS('SomeJavaList').DoSelectItem(items, separator, itemsType)
```
