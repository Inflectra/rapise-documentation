...
```javascript
value = SeS('SomeUltraFontNameEditor').GetSelectedIndex()
...
```javascript
value = SeS('SomeUltraFontNameEditor').GetSelectedItem()
...
```javascript
value = SeS('SomeUltraFontNameEditor').GetText()
...
```javascript
SeS('SomeUltraFontNameEditor').DoSelectItem(item)
```
...
```javascript
SeS('SomeUltraFontNameEditor').DoSetText(val)
```
