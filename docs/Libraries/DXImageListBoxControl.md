Summary: DevXpress ImageListBoxControl.
...
```javascript
SeS('SomeDXImageListBoxControl').DoAddSelection(items, separator, itemsType)
```
...
```javascript
SeS('SomeDXImageListBoxControl').DoClearSelection()
```
...
```javascript
SeS('SomeDXImageListBoxControl').DoRemoveSelection(items, separator, itemsType)
```
...
```javascript
SeS('SomeDXImageListBoxControl').DoSelectItem(items, separator, itemsType)
```
