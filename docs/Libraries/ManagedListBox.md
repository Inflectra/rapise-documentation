...
UI element class: System.Windows.Forms.ListBox
...
```javascript
value = SeS('SomeManagedListBox').GetItemCount()
```
...
```javascript
value = SeS('SomeManagedListBox').GetItemIndexByName(name)
```
...
```javascript
value = SeS('SomeManagedListBox').GetItemNameByIndex(index)
```
...
```javascript
value = SeS('SomeManagedListBox').GetSelectedIndex()
...
```javascript
value = SeS('SomeManagedListBox').GetSelectedIndices(asArray, separator)
```
...
```javascript
value = SeS('SomeManagedListBox').GetSelectedItems()
```
...
```javascript
value = SeS('SomeManagedListBox').GetSelectedText()
```
...
```javascript
value = SeS('SomeManagedListBox').GetSelectionCount()
```
...
```javascript
SeS('SomeManagedListBox').DoAddSelection(items, separator, itemsType)
```
...
```javascript
SeS('SomeManagedListBox').DoClearSelection()
```
...
```javascript
SeS('SomeManagedListBox').DoRemoveSelection(items, separator, itemsType)
```
...
```javascript
SeS('SomeManagedListBox').DoSelectItem(items, separator, itemsType)
```
