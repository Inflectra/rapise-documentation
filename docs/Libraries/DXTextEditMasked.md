Summary: DevXpress Masked TextEdit.
...
```javascript
value = SeS('SomeDXTextEditMasked').GetText()
...
```javascript
SeS('SomeDXTextEditMasked').DoSetText(val)
```
...
<a name="see.also.dxtexteditmasked.dosettext"></a>
