...
```javascript
value = SeS('SomeJavaSwingComboBox').GetItemIndexByName(name)
```
...
```javascript
value = SeS('SomeJavaSwingComboBox').GetSelectedIndex()
...
```javascript
value = SeS('SomeJavaSwingComboBox').GetSelectedText()
