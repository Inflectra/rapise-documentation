...
UI element class: javax.swing.JRadioButton
...
```javascript
value = SeS('SomeJavaSwingRadioButton').GetChecked()
...
```javascript
SeS('SomeJavaSwingRadioButton').DoSetCheck(bcheck)
```
...
<a name="see.also.javaswingradiobutton.dosetcheck"></a>
