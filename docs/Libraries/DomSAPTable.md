...
```javascript
value = SeS('SomeDomSAPTable').GetCell(/**number|string*/row, /**string|number*/col)
```
...
```javascript
value = SeS('SomeDomSAPTable').GetColumnCount()
```
...
```javascript
value = SeS('SomeDomSAPTable').GetColumnIndex(/**string*/columnName)
```
...
```javascript
value = SeS('SomeDomSAPTable').GetColumnName(/**number*/columnIndex)
```
...
```javascript
value = SeS('SomeDomSAPTable').GetRowCount()
```
