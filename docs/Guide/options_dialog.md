...
!!! note 
    MCP is an experimental feature and it is disabled by default. Once you enable it, note that you must have only one instance of Rapise running and MCP server will work with it.
