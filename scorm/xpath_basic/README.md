...
``` xml @xpathExample(` `,`//input[<at>aria-labelledby=//label[text()="I agree to the Terms and Conditions."]/<at>id]`)
<div _root>
...
``` xml @xpathExample(` `,`//input[<at>id=//label[text()="Do you like peas?"]/<at>for]`)
<div _root>
